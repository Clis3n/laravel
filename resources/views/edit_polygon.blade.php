    ...
    <div class="modal fade" id="EditPolygonModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('polygons.update', $id) }}" id="form-edit-polygon" enctype="multipart/form-data" action="{{ route('polygons.store') }}" enctype="multipart/form-data">
